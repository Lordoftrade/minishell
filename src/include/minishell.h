...
void			process_dollar(char *string, int *i,
...
void			setup_child_pipes(int prev_fd, int read,
					int write, t_command *curr);
void			handle_parent_process(int *prev_fd, int read,
					int write, t_command **curr);
